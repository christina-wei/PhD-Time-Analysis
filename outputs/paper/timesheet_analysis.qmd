...
abstract: "Many PhD students have trouble with their work-life balance and coping with the stress of their workloads. I undertook a quantitative autoethnography of my own time management skills. I analyzed my own timesheet data to understand my behavioural patterns over the first two semesters of my PhD. I found that I am spending more than 40 hours a week on PhD-related work, with most of my time spent on research, course work, and teach assistant related activities. There is evidence of improper work-life balance based on my tendency to work during the late evening and on weekends. To strive for better balance, I have outlined several suggestions to purposefully plan for each day, as well as created prediction models to estimate and plan for upcoming projects."
...
Pursing a PhD degree can be an intellectually fulfilling journey to be at the forefront of academic knowledge. However, this can also be a diﬀicult journey, and many students struggle to cope with the stress of the work. Based on a study conducted on more than 3,500 PhD students in Belgium, @levecque2017work found that 50% of students experienced psychological distress during their PhD, with more than 30% at risk of developing a psychiatric disorder, especially depression. @worklifebalance show that around 70% of students do not perceive themselves having good work-balance balance, with 90% of them reporting an imbalance in their personal life. Reading these cautionary tales makes me question whether my own work-life balance is appropriate.

While I feel like I have a good handle on my stress level and actively manage my work-life balance, in this paper I quantitatively assess whether I am achieving these goals. I have tracked the time I spent on academic work since I started as a PhD student at the University of Toronto. This enables me to analyze my timesheet data to answer the question of whether I have a good work-life balance in my PhD journey. For this analysis, I am using the amount of tracked time I spent on academic work as the estimand for the proportion of work in my life, while considering the time I do not track as non-work related.
