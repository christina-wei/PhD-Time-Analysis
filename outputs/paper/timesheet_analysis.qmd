...
abstract: "TBD"
thanks: "Code and data supporting this analysis is available at: hhttps://github.com/christina-wei/PhD-Time-Analysis.git"
...
First, I can be more efficient with my time by defining a couple of topics to focus on at the beginning of each day, and engage in work sessions that are no longer than 2 hours in length. This is in line with my behavioural patterns, as I tend to have study sessions around 2 hours length, and focus on 1 to 3 projects per day. The caveat to this is if I get into the flow of the work, then the work sessions can be longer as not to disturb the deep engagement for the session.

Second, this analysis shows that I have been spending significant amount of time working on weekends, which is not ideal for work-life balance and spending time with family. Tracking social times to analyze work life balance?

Third, better planning - use the model
...
Changing schedules - regime switching (e.g. finishing course work)

# Conclusion

# Appendix {.unnumbered}

See @fig-app-screenshot for a snapshot of the Shiny application.
